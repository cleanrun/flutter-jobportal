...
import 'package:job_portal/models/serializers.dart';
...
class BuiltValueConverter extends JsonConverter{
  ...
  Request convertRequest(Request request) {
    return super.convertRequest(
      request.replace(
        body: serializer.serializeWith(
          serializer.serializerForType(request.body.runtimeType), request.body
        ),
      ),
    );
  }
  ...
  SingleItemType _deserialize<SingleItemType>(Map<String, dynamic> value) {
    return serializer.deserializeWith(serializer.serializerForType(SingleItemType), value);
  }
}